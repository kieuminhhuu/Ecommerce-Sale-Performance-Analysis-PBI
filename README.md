...
# Introduction
- Đặt vấn đề:
  - Superstore là một công ty bán hàng có cửa hàng trên toàn thế giới. Senior Manager muốn nắm được thông tin về tình hình kinh doanh của công ty để đưa ra chiến lược mở rộng thị trường và quyết định lựa chọn sản phẩm chiến lược. Sử dụng PowerBI để trực quan hóa Insight từ đó đưa ra các Recommendation cho doanh nghiệp
